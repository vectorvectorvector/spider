...
//				System.out.println(sb.toString());
                ...
                System.out.println("DataUtil网络连接错误：" + conn.getResponseCode());
...
//				System.out.println(sb.toString());
                ...
                System.out.println("DataUtil错误状态码：" + conn.getResponseCode());
//				throw new CommonException("访问网络失败00");
            }
...
//			throw new CommonException("访问网络失败11");
    ...
    public static String doPostCharset(String urlStr, String charset) //throws CommonException
    {
        StringBuffer sb = new StringBuffer();
        try {
            URL url = new URL(urlStr);
